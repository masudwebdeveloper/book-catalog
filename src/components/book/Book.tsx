...
const Book: React.FC<BookProps> = ({ book }) => {
  const { title, author, genre, publication, thumnail } = book;
  console.log(book);

  return (
    <div className="rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100">
	<img src={thumnail} alt="" className="object-catain h-72 object-center w-full rounded-t-md dark:bg-gray-500" />
